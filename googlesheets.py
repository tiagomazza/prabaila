...
if all(credentials.values()):
    ...
    # Verifica se há dados filtrados antes de iterar
    if not data.empty:
        ...
        st.write("Não há dados disponíveis para exibição.")
else:
    st.error("As credenciais necessárias não foram fornecidas. Verifique se todas as variáveis de ambiente estão configuradas corretamente.")
