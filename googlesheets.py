...
if pagina_selecionada == "Verificação de estoque":
    ...
    numeros_europeus_selecionados = st.multiselect("Quais números europeus deseja consultar?", numeros.astype(int), default=[])
    ...
    # Adicionar botão com link para o WhatsApp
        ...
        st.subheader(f"Gostou deste modelo? veja converse connosco pelo [WhatsApp](%s)" % whatsapp_link)
