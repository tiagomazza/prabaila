...
# Sidebar navigation
pagina_selecionada = st.sidebar.radio("Navegação", ["Página Principal", "Segunda Página"])
...
# Segunda Página
elif pagina_selecionada == "Segunda Página":
    st.write("Você está na Segunda Página!")
